            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12 mb-5">
                        <img src="<?php echo base_url() ?>assets/img/underline2.png" class="img-fluid img-line img-col-md" style="width: 17rem; right: 76%;">
                        <h2 class="color-primary text-bold">DETAIL AGENDA</h2>
                        <h6 class="fs-secondary float-end breadcrumb-landingpage img-col-md"><a class="text-muted"><a href="<?= base_url() ?>agenda">Agenda</a><span class="text-grey-light"> / Detail Agenda</span></a></h6>
                        <h6 class="fs-secondary breadcrumb-landingpage img-col-xs mb-4" style="top:0px;"><a class="text-muted"><a href="<?= base_url() ?>agenda">Agenda</a><span class="text-grey-light"> / Detail Agenda</span></a></h6>
                    ...
                    <?php foreach ($data as $row) { ?>
                        <div class="row g-0">
                            <div class="col-md-3 detail-left">
                                ...
                                <?php } ?>
                                <h6 class="mt-5">Download Dokumen PDF di bawah ini</h6>
                                <?php if ($row->file != '') { ?>
                            ...
                            <div class="col-md-9">
                                <div class="card-body">
                                    <h4 class="text-bold card-title"><?= $row->judul ?></h4>
                                    <p class="card-text">
                                        <p class="text-grey-light text-muted"><i class="mdi mdi-calendar"></i>&nbsp;<?= $this->informasi_model->tgl_indo($row->tanggal) ?></p>
                                    </p>
