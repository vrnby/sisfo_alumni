    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <h2 class="text-bold">BANTUAN</h2>
                        <p class="fs-secondary text-grey-light subtitle">Temukan jawaban dari pertanyaan Anda di sini</p>
                    </div>
        ...
        <section class="cd-faq">
            <ul class="cd-faq-categories">
                <li><a class="selected" href="#basics">Setup</a></li>
                <li><a href="#mobile">Base</a></li>
