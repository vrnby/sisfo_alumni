                ...
                <div class="container-fluid">
                    ...
                    <div class="row row-dashboard">
                        <div class="col-md-12 mt-1">
                            ...
                            <div class="row">
                                <span class="text-muted"><a href="<?= base_url() ?>admin/wisuda">Jadwal Wisuda</a> / Detail Jadwal Wisuda</span>
                            </div>
                        </div>
                    </div>
                    <!-- Jadwal Wisuda -->
                        ...
                        <div class="col-12">
                            <div class="card pt-4">
                                <div class="col-lg-12">
                                    ...
                                    <a href="<?php echo base_url() ?>admin/wisuda/add" class=" float-end btn btn-primary"><span class="mdi mdi-plus"> Tambah</span></a>
                                </div>
                                                        ...
                                                        <tbody class="fw-bolder">
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    <a href="<?= base_url() ?>admin/wisuda/jadwal/detail/edit"><i class="btn btn-sm mdi mdi-square-edit-outline text-success"></i></a>
