                ...
                <div class="container-fluid">
                    ...
                    <div class="row row-dashboard">
                        <div class="col-md-12 mt-1">
                            <div class="row">
                                <div class="fw-bolder fs-2">Ubah Jadwal Wisuda</div>
                            </div>
                            <div class="row">
                                <span class="text-muted"><a href="<?= base_url() ?>admin/wisuda">Jadwal Wisuda</a> / Ubah Jadwal Wisuda</span>
                            </div>
                        </div>
                    </div>
                    <!-- Jadwal Wisuda -->
                                            ...
                                            <form action="#" method="POST" class="needs-validation" novalidate>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12 mt-3">
                                                        ...
                                                        <input type="text" class="form-control" id="nama" name="nama" value="Wisuda ke 52 - Daring Jan 2021" required>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-lg-4 mt-3">
                                                        ...
                                                        <input type="number" class="form-control" id="tot_kuota" name="tot_kuota" value="936" required>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-lg-4 mt-3">
                                                        ...
                                                        <input type="number" class="form-control" id="tot_wisudawan" name="tot_wisudawan" value="936" required>
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-lg-6 mt-3">
                                                        ...
                                                        <input type="date" class="form-control" id="tgl_wisuda" name="tgl_wisuda" value="31-03-2021 09:00" required>
                                                        <div class="invalid-feedback">
