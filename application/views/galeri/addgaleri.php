                ...
                <div class="container-fluid">
                    ...
                    <div class="row row-dashboard">
                        <div class="col-md-12 mt-1">
                            <div class="row">
                                <div class="fw-bolder fs-2">Tambah Foto</div>
                            </div>
                            <div class="row">
                                <span class="text-muted"><a href="<?= base_url() ?>admin/galeri">Daftar Galeri</a> / Tambah Foto</span>
                            </div>
                        </div>
                    </div>
                    <!-- Jadwal Wisuda -->
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row justify-content-between">
                                        <div class="col-12">
                                            <h5 class="card-title ms-1 text-info">Tambah Foto</h5>
                                        </div>
                                    </div>
                                    <div class="row mt-2 pe-5 ps-5">
                                        <div class="col">
                                            <form action="<?=base_url()?>galeri/store" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 mt-3">
                                                        ...
                                                        <input type="date" class="form-control" id="tgl_foto" name="tgl_foto" required>
                                                        <div class="invalid-feedback">
                                                            Pilih tanggal foto!
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12 container-foto mt-3">
                                                        ...
                                                        <input class="form-control" type="file" id="input-file" name="input-file" required accept="image/*" onchange={handleChange()} hidden />
                                                ...
                                                <button type="submit" class="btn button-primary-custom btn-sm ps-4 pe-4 pt-2 pb-2  mt-4 mb-5 float-end continue">
                                                    <span class="mdi mdi-plus"> Tambah </span>
                                                </button>
