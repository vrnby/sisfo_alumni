...
<body class="hold-transition sidebar-mini layout-fixed alumni-auth" style="background: #f8f8f8">
                ...
                <div class="container-fluid">
                    <div class="row row-dashboard">
                        <div class="col-md-4 mt-1">
                            <div class="row">
                                <div class="fw-bolder fs-2">Tambah Informasi</div>
                            </div>
                            <div class="row">
                                <span class="text-muted">Informasi / Tambah Informasi</span>
                            </div>
                        </div>
                    </div>
                    <div class="row row-dashboard2">
                        <div class="col-12">
                            <form action="<?= base_url() ?>informasi/store" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                                <!-- <form class="needs-validation" novalidate>                         -->
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="judul_informasi" name="judul_informasi" placeholder="Judul..." required>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-floating">
                                            <select class="form-select" id="jenis_informasi" name="jenis_informasi" aria-label="Floating label select example" required>
                                                ...
                                                <?php foreach ($tipe_informasi as $row) { ?>
                                ...
                                <textarea rows="25" id="post_content" name="content_informasi" class="form-control ckeditor"></textarea>
                            </form>
                        </div>
                    </div>
    ...
    <!-- <script>          
        tinymce.init({
            ...
            image_advtab: true,
            images_upload_url: "<?= base_url() ?>informasi/tinymce_upload/1",
